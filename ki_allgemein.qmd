...
Eine KI ist in der Regel ein Neuronales Netz hoher Komplexität, welches adaptiv neues "Wissen" erarbeiten kann und in den meisten Fällen menschliche Sprache "versteht".

:::{.callout-note title="Neuronale Netze" collapse="true"}

Ich weiß nicht inwiefern dir der Begriff Neuronales Netz etwas sagt.  
Die **Grundidee** ist an menschlichen Neuronen an


<iframe src="Quellen/Lernalgorithmen.pdf" width="100%" height="600px">
